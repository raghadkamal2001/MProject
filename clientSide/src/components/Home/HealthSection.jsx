...
//           <Newspaper className="text-[#383838] w-8 h-8" /> أخبار في الصحة
//         </h2>
...
//                 style={{ backgroundImage: `url(https://images.unsplash.com/photo-1740715537042-6de862cdaab4?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyfHx8ZW58MHx8fHx8)` }}
//               >
...
getNewsSlide();
  ...
  <div className="h-6 w-1 bg-[#51a31d]"></div>
    <span className="text-2xl font-bold text-black">أخبار في الصحة :</span>
